...
const translations = {
  ...
  en: {
    ...
    intro: "Here you will find a collection that blends classical and digital painting techniques, from impressionist strokes to abstract compositions generated by artificial intelligence.",
  ...
  fr: {
    ...
    intro: "Vous trouverez ici une collection qui combine des techniques picturales classiques et numériques, allant des touches impressionnistes aux compositions abstraites générées par l'intelligence artificielle.",
  ...
  ja: {
    ...
    intro: "ここでは、印象派の筆致から人工知能によって生成された抽象的な構成まで、古典的およびデジタル絵画技法を融合させたコレクションをご覧いただけます。",
